...
public class SandboxMapas
{
    ...
    public List<String> getValoresComoLista( ){
    	TreeSet<String> orden = new TreeSet<>(mapaCadenas.values());
    ...
    public List<String> getLlavesComoListaInvertida( ){
    	NavigableSet<String> inverso = new TreeSet<>(mapaCadenas.keySet()).descendingSet();
    	return new ArrayList<>(inverso);
    }
    ...
    public String getPrimera( ){
    	...
    	TreeSet<String> orden = new TreeSet<>(mapaCadenas.keySet());
    	return orden.first();
    }
    ...
    public void volverMayusculas( ){
    	...
    	for (Map.Entry<String, String> palabra : mapaCadenas.entrySet()) {
    		String minuscula = palabra.getKey().toLowerCase();
    		String valor = palabra.getValue();
    		nuevo.put(minuscula.toUpperCase(), valor);
    	}
    	mapaCadenas = nuevo;
    }
