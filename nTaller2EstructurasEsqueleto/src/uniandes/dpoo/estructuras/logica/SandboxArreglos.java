...
public class SandboxArreglos
{
    ...
    public int[] getCopiaEnteros( ) {
    	int[] copyEnteros = new int[arregloEnteros.length];
    	for (int i = 0; i < arregloEnteros.length; i++) {
    		copyEnteros[i] = arregloEnteros[i];
    	}
        return copyEnteros;
    }
    /**
    ...
    public String[] getCopiaCadenas( ){
    	String[] copyCadenas = new String[arregloCadenas.length];
    	for (int i = 0; i < arregloCadenas.length; i++) {
    		copyCadenas[i] = arregloCadenas[i];
    	}
        return copyCadenas;
    }
    /**
    ...
    public void agregarEntero( int entero ){
    	int[] newvalor = new  int[arregloEnteros.length + 1];
    	for (int i = 0; i < arregloEnteros.length; i++){
    		newvalor[i] = arregloEnteros[i];
    	}
    	newvalor[newvalor.length - 1] = entero;
    	arregloEnteros = newvalor;
    }
    ...
    public void agregarCadena( String cadena ){
    	String[] newcadena = new  String[arregloCadenas.length + 1];
    	for (int i = 0; i < arregloCadenas.length; i++){
    		newcadena[i] = arregloCadenas[i];
    	}
    	newcadena[newcadena.length - 1] = cadena;
    	arregloCadenas = newcadena;
    }
    ...
    public void eliminarEntero( int valor ){
    	...
    	int[] nuevoArreglo = new int[valores];
    	int valoresNuevoArreglo = 0;
    	for (int i = 0; i < arregloEnteros.length; i++){
    		if (arregloEnteros[i] != valor) {
    			nuevoArreglo[valoresNuevoArreglo] = arregloEnteros[i];
    			valoresNuevoArreglo++;
    		}
    	}
    ...
    public void eliminarCadena( String cadena ){
    	...
    	arregloCadenas = nuevaLista.toArray(new String[0]);
    }
    ...
    public int[] buscarEntero( int valor ){
    	ArrayList<Integer> posicionList = new ArrayList<>();
    	for (int i = 0; i < arregloEnteros.length; i++) {
    		if (arregloEnteros[i] == valor) {
    			posicionList.add(i);
    		} 
    	...
    	int[] posicion = new int[posicionList.size()];
    	
    	for (int i = 0; i < posicionList.size(); i++) {
    		posicion[i] = posicionList.get(i);
    	}
        return posicion;
    }
    ...
    public int contarEnterosRepetidos( ){
    	HashMap<Integer, Integer> repetir = new HashMap<>();
    	for (int num: arregloEnteros) {
    		repetir.put(num, repetir.getOrDefault(num, 0) + 1);
    	}
    	int contar = 0;
    	for (int valor: repetir.values()) {
    		if (valor > 1) {
    			contar++;
    		}
    	}
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo ){
    	...
    	for (int i = 0; i < cantidad; i++) {
    		int valores = (int) (Math.random() * rango) + minimo;
    		nuevoArreglo[i] = valores;
    	}
    	arregloEnteros = nuevoArreglo;
