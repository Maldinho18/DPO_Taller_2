...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida( ){
    	List<String> nuevaLista = new ArrayList<>(arbolCadenas);
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena ){
    	String minmax = cadena.toLowerCase();
    	TreeSet<String> nuevaLista = new TreeSet<>();
    	for (String palabra : arbolCadenas) {
    		String minmax_2 = palabra.toLowerCase();
    		if (minmax_2.equals(minmax)) {
    			nuevaLista.add(palabra);
    		}
    	}
    	arbolCadenas.removeAll(nuevaLista);
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos ){
    	arbolCadenas.clear();
    	for (Object palabra : objetos) {
    		String cadena = palabra.toString();
    		arbolCadenas.add(cadena);
    	}
    }
    ...
    public void volverMayusculas( ){
    	TreeSet<String> nuevaLista = new TreeSet<>();
    	for (String palabra : arbolCadenas) {
    		nuevaLista.add(palabra.toUpperCase());
    	}
    	arbolCadenas = nuevaLista;
    }
    ...
    public TreeSet<String> invertirCadenas( ){
    	TreeSet<String> nuevaLista = new TreeSet<>(Comparator.reverseOrder());
    		nuevaLista.addAll(arbolCadenas);  	
        return nuevaLista;
    }
    ...
    public boolean compararElementos( String[] otroArreglo ){
    	for (String palabra : otroArreglo) {
    		if (!arbolCadenas.contains(palabra)) {
    			return false;
    		}
    	}
        return true;
