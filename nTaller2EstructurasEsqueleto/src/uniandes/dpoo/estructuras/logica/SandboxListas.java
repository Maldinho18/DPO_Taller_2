...
public class SandboxListas
{
    ...
    public void reiniciarArregloCadenas( List<Object> objetos ){
    	...
    	for (Object palabra : objetos) {
    		listaCadenas.add(palabra.toString());
    	}
    }
    ...
    public int contarApariciones( String cadena ){
    	...
    	int contar = 0;
    	for (String palabras : listaCadenas) {
    		String palabrasMinusculas = palabras.toLowerCase();
    		if (palabrasMinusculas.equals(minusculas)) {
    			contar++;
    		}
    	} 
        return contar;
    ...
    public int contarEnterosRepetidos( ){
    	...
    	int contar = 0;
    	for (int numeros : listaEnteros) {
    		if (!repetidos.add(numeros)) {
    			contar++;
    		}
    	}
    	return contar;
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo ){
    	...
    	for (int i = 0; i < cantidad; i++) {
    		int numerosRandom =(int) (Math.random()*(maximo - minimo + 1)) + minimo;
    		listaEnteros.add(numerosRandom);
    	}
    }
